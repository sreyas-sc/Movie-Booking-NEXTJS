...
//       {/* Movie Details Card */}
//       {movieDetails && (
//         <div style={{ flex: 1, backgroundColor: '#fff', borderRadius: '8px', padding: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
//           <h2 style={{ fontSize: '20px', marginBottom: '20px' }}>Selected Movie</h2>
//           <img
