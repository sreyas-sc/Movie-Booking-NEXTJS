...
//                 Showtimes: {theater.showtimes ? theater.showtimes.map(st => st.time).join(', ') : 'No showtimes available'}
...
// **********************************use the above code if build failed*****************************************
...
const AddTheater = () => {
  ...
  // useEffect(() => {
  //   getAllMovies()
  //     .then((data: Movie[]) => setMovies(data)) // Type added for fetched data
  //     .catch((err) => console.log(err));
  // }, []);
