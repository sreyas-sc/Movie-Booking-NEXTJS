...
//         // Handle multiple cast photos
//         setCast((prev) => [...prev, ...files.map(file => file.name)]);
//         // You may want to store the File objects if needed for submission
//       }
//     }
//   };
...
//   cast.forEach((member) => formData.append('castPhotos', member)); // Include cast photos
